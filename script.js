(function(){
  ...
  const projects = [
    ...
    { id: 3, title: "Сайт компании грузоперевозок «Везу Ваш груз»", desc: "Визуальная концепция и вёрстка (в процессе).", category: "web", imageLabel: "transportation", tag: "Веб-дизайн" },
    { id: 4, title: "Дизайн-эскиз стены для пункта выдачи компании «Ozon»", desc: "Графический дизайн.", category: "graphic", imageLabel: "ozon", tag: "Граф. дизайн" },
  ...
  const projectDetails = {
    ...
    4: { fullDesc: 'Дизайн-эскиз стены для пункта выдачи компании «Ozon», эскиз был перенесен на стену с помощью робота. Пункт выдачи с моим дизайн эскизом расположен по адресу г. Москва, 3-я Парковая улица, 34', link: '#', images: ['card_3.2.png'] },
    3: { fullDesc: 'Создание полноценного веб-сайта для компании грузоперевозок «Везу Ваш груз». Проект включал дизайн интерфейса, адаптивную вёрстку и frontend-разработку. Главная страница рассказывает о компании, содержит информацию об услугах, тарифах и контактах.', link: '#', images: ['card_4.jpg','card_4.2.jpg','card_4.3.jpg','card_4.4.jpg','card_4.5.jpg'] },
